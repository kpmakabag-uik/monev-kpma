              ...
              <td className="px-6 py-4 text-right whitespace-nowrap">
                ...
                {userRole === "KPMA" && (
                  <Link 
                    ...
                    className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-xs font-bold transition-all shadow-sm ml-2"
                  >
